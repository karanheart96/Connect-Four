...
class Menu(QWidget):
    ...
    def __init__(self, parent):
        ...
        # HEADER
        cs5100 = QLabel('CS5100')
        cs5100.setAlignment(Qt.AlignCenter)
        cs5100.setFont(QFont('Times', 24, QFont.Bold))
        vbox.addWidget(cs5100)
        hw2 = QLabel('Project 1: Connect-Four')
        ...
        # Player 1 Options
        player1 = QComboBox()
        player1.addItems(['Human', 'Random', 'AI-Minimax-Cutoff', 'AI-Minimax-Vanila', 'AI-AlphaBeta-Cutoff', 'AI-AlphaBeta-Vanila'])
        ...
        # Player 2 Options
        player2 = QComboBox()
        player2.addItems(['Human', 'Random', 'AI-Minimax-Cutoff', 'AI-Minimax-Vanila', 'AI-AlphaBeta-Cutoff','AI-AlphaBeta-Vanila'])
...
class MainWindow(QWidget):
    ...
    def __init__(self):
        ...
        self.resize(512, 512)
        self.setWindowTitle('CS5100 - Project 1 - Connect-Four')
