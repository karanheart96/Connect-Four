...
from bot import randomBot, alphaBetaBot, minMaxBot, HumanPlayer, alphaBetaCutoffBot, minMaxCutoffBot
...
class Game(QWidget):
    ...
    players = {
        'Human': HumanPlayer,
        'Random': randomBot,
        'AI-Minimax-Cutoff': minMaxCutoffBot,
        'AI-Minimax-Vanila': minMaxBot,
        'AI-AlphaBeta-Cutoff': alphaBetaCutoffBot,
        'AI-AlphaBeta-Vanila': alphaBetaBot
    }
